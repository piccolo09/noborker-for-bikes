...
class VehicleCategory(models.Model):
    name = models.CharField(_("Vehicle Cateogry Name"),max_length=255,)
...
class VehicleManufacturer(models.Model):
    name = models.CharField(_("Vehicle Manufacturer Name"),max_length=255,)
    slug = models.SlugField(unique=True)
...
class VehicleModel(models.Model):
    ...
    category = models.ForeignKey(VehicleCategory, on_delete=models.RESTRICT, related_name="models",blank=True,null=True)
